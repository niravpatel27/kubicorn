	...
	machineSetsProviderConfigs := []*cluster.MachineProviderConfig{
		{
			ServerPool: &cluster.ServerPool{
				...
				Size:     "k4-highcpu-kvm-1.75G",
				BootstrapScripts: []string{
					"bootstrap/triton_k8s_ubuntu_16.04_master.sh",
				},
			},
		},
		{
			ServerPool: &cluster.ServerPool{
				...
				Size:     "k4-highcpu-kvm-1.75G",
				BootstrapScripts: []string{
					"bootstrap/triton_k8s_ubuntu_16.04_node.sh",
				},
			},
		},
	}
