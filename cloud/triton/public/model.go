...
import (
	...
	"github.com/kubicorn/kubicorn/cloud/triton/public/resources"
...
func NewTritonComputeModel(known *cluster.Cluster) cloud.Model {
	return &Model{
		known: known,
	}
}
...
func (m *Model) Resources() map[int]cloud.Resource {
	...
	m.cachedResources = r
	j, _ := json.Marshal(r)
	logger.Debug("TritonModel: %v", string(j))
	return m.cachedResources
}
